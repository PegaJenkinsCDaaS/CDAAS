...
usage() {
	echo "prpcServiceUtils.sh export | expose | hotfix | import | getStatus | manageTrackedData | rollback | manageRestorePoints | updateAccessGroup | appConfig | help [options...]"
	echo ""
	echo "Options:"	
